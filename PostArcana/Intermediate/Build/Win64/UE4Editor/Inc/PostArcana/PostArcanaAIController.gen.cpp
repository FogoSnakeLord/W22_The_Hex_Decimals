...
#include "PostArcana/AI/PostArcanaAIController.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APostArcanaAIController_OnPerceptionUpdated_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "AI/PostArcanaAIController.h" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_APostArcanaAIController_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_APostArcanaAIController_OnPerceptionUpdated, "OnPerceptionUpdated" }, // 4266055442
		{ &Z_Construct_UFunction_APostArcanaAIController_OnTargetPerceptionUpdate, "OnTargetPerceptionUpdate" }, // 2861858997
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APostArcanaAIController_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "AI/PostArcanaAIController.h" },
		{ "ModuleRelativePath", "AI/PostArcanaAIController.h" },
	};
#endif
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(APostArcanaAIController, 3365065700);
